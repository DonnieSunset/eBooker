...
namespace BE_iTest
{
    public class EBookTests
    {
        ...
        public void UpdateAuthors_MetaDataMissing_AuthorAdded()
        {
            ...
            var eBook = new eBook(ebookTempFileLocation);
            Assert.That(eBook.GetAuthors().Item1, Is.Null, "Author1");
            Assert.That(eBook.GetAuthors().Item2, Is.Null, "Author2");
            ...
            Assert.That(eBook.GetAuthors().Item1, Is.Not.Null, "Author1");
            Assert.That(eBook.GetAuthors().Item1.SortName, Is.EqualTo("McQuillington, Chuckle"));
            Assert.That(eBook.GetAuthors().Item2, Is.Null, "Author2");
        }
        ...
        public void UpdateAuthors_TwoAuthorsAdded_AuthorAdded()
        {
            ...
            eBook = new eBook(ebookTempFileLocation);
            Assert.That(eBook.GetAuthors().Item1, Is.Not.Null, "Author1");
            Assert.That(eBook.GetAuthors().Item1.DisplayName, Is.EqualTo("Chuckle McQuillington"));
            Assert.That(eBook.GetAuthors().Item2, Is.Not.Null, "Author2");
            Assert.That(eBook.GetAuthors().Item2.DisplayName, Is.EqualTo("Stephen King"));
        }
